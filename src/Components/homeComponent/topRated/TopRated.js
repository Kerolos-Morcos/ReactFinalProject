...
function TopRated() {
  ...
  return (
    ...
    pagination={{ 
      ...
      renderBullet: function (index, className) {
        if (index < 7) { // limit the number of bullets to a dynamic number
  ...
  <section className={`${"doctors-wrapper "} ${TopStyle.section_padding}`}>
        ...
        <SwiperSlide className={`${"col-md-6 col-lg-4 col-12"}`}>
          <div className={`${TopStyle.single_doctor}`}>
            ...
            <div className={`${TopStyle.doctor_social_icons}`}>
              <a href="#"  >
                <i className={"fa fa-user-nurse fa-bounce"}></i> بادر بالحجز   
